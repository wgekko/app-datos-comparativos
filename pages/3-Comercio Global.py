...
@st.cache_data
def load_data():
    df = pd.read_excel("datos/comercio-exportaciones-importaciones-%-PBI.xlsx")
    return df

df = load_data()


st.header("Análisis de Comercio a Nivel Global")
st.write("---")

st.header(":material/business_messages: Gráficos de Dispersión mejorados con gráficos de Margen y animaciones")
...
variables = ['Comercio  Mercaderias % PBI',	'Exportacion bienes servicios % PBI', 'Importacion bienes servios % PBI']
